  ...
  const renderOverview = () => (
    <div className="view-content fade-in">
      <header className="page-header">
        ...
        <p>
          Welcome back! Here's what's happening in your extraction pipeline.
        </p>
      </header>
      ...
      <div className="stats-grid">
        ...
        <div className="stat-card glass">
          ...
          <div className="stat-info">
            <span className="stat-value">
              {Array.isArray(documents) && documents.length > 0
                ? Math.round(
                    (documents.filter(
                      (d) =>
                        d.status === "verified" || d.status === "di_processed",
                    ).length /
                      documents.length) *
                      100,
                  )
            ...
            <span className="stat-label">VERIFIED & EXTRACTED</span>
          </div>
        </div>
        <div className="stat-card glass">
      ...
      <div className="dashboard-content-grid">
        <div className="documents-container full-width glass">
          <div className="section-header">
            ...
            <button className="btn-text" onClick={fetchDocuments}>
              Refresh
            </button>
          </div>
